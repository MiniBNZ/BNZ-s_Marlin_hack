...
#define  DEFAULT_Kp 41.62
#define  DEFAULT_Ki 3.56
#define  DEFAULT_Kd 121.72
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  #define  DEFAULT_bedKp 75.72
  #define  DEFAULT_bedKi 2.09
  #define  DEFAULT_bedKd 684.79
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.00  // Z probe to nozzle Z offset: -below (always!)
...
#define HOMING_FEEDRATE {25*60, 25*60, 1*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {64.3,64.3,1529,720}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 3}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {800,800,50,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
